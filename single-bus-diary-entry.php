...
<section class="bus-diary-entry viewport-active">
	<div class="wp-block-cover bus-diary-entry__hero hero-background" style="min-height:68vh;">
		<div class="overlay">
		...
		<div class="wp-block-group">
			<div class="bus-stage" id="bus-stage">
				...
				<div class="bus-stage__view is-active" data-view="map">
					<div class="bus-diary-entry__split-stage">
						<div class="bus-diary-entry__split-media">
						...
						<div class="bus-diary-entry__split-map">
							<div class="bus-panel bus-panel--map bus-panel--map-primary" id="bus-stage-map">
				...
				<div class="bus-stage__view" data-view="departures">
